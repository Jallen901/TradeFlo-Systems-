...
const tiers = [
  {
    ...
    cadence: 'One-Time',
    features: [
      'A site that converts visitors to calls',
      'Trade-specific copy + local SEO',
  ...
  },
  {
    ...
    cadence: '/month',
    features: [
      'Rank in the map pack for your trade',
      'Reviews stack automatically',
      'Monthly report — no guessing',
      'Local citation building across 50+ directories',
      'Competitor tracking so you stay ahead',
      'Content updates that keep your SEO climbing',
    ],
  ...
  },
  {
    ...
    cadence: '/month',
    features: [
      'Missed call texted back in under 60s',
      'AI handles follow-up while you work',
      'Google Ads managed for max ROI',
      'Estimate request pipeline — no more chasing leads',
      'Reputation management on autopilot',
      'Everything in Steps 1 & 2 included',
    ],
